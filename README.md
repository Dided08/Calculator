...
Для конфигурации порта и URL используйте файл .env также можно настроить время выполнения задач:

    TIME_ADDITION_MS - Время выполнения сложения (мс). По умолчанию 100
    TIME_SUBTRACTION_MS - Время выполнения вычитания (мс). По умолчанию 100
    TIME_MULTIPLICATIONS_MS - Время выполнения умножения (мс). . По умолчанию 200
    TIME_DIVISIONS_MS - Время выполнения деления (мс). По умолчанию 200
